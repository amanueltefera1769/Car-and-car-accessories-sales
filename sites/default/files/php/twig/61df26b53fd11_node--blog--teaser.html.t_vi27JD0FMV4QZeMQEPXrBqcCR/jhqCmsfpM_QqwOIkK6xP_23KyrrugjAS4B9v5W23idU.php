...
/* themes/sshop/templates/node/blog/node--blog--teaser.html.twig */
class __TwigTemplate_6a71545485804a5e6f257f51e06155cde0737a5d16f462d46c7bd8abc6b2991b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 75, $this->source))) : ("")), 6 => "clearfix"];
  ...
  <div";
        // line 81
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", [0 => "content"], "method", false, false, true, 81), 81, $this->source), "html", null, true);
        echo ">
    <div class=\"row\">
      <div class=\"col-sm-6 contents-left\">
        ";
        // line 84
      ...
      <div class=\"col-sm-6 contents-right\">
        ";
        // line 87
        ...
        if ( !($context["page"] ?? null)) {
            // line 89
            echo "          <h2";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title_attributes"] ?? null), 89, $this->source), "html", null, true);
            echo ">
            <a href=\"";
            // line 90
        ...
        ";
        // line 112
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "body", [], "any", false, false, true, 112), 112, $this->source), "html", null, true);
        echo "
        ";
        // line 113
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "links", [], "any", false, false, true, 113), 113, $this->source), "html", null, true);
        echo "
      </div>
    </div>
  </div>
...
";
    ...
    {
        return "themes/sshop/templates/node/blog/node--blog--teaser.html.twig";
    }
    ...
    {
        return array (  130 => 113,  126 => 112,  123 => 111,  116 => 107,  111 => 105,  104 => 101,  98 => 98,  94 => 97,  91 => 96,  89 => 95,  83 => 93,  75 => 90,  70 => 89,  68 => 88,  64 => 87,  58 => 84,  52 => 81,  46 => 79,  44 => 75,  43 => 73,  42 => 72,  41 => 71,  40 => 70,  39 => 69,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/sshop/templates/node/blog/node--blog--teaser.html.twig", "C:\\xampp\\htdocs\\drupal\\themes\\sshop\\templates\\node\\blog\\node--blog--teaser.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 69, "if" => 88);
