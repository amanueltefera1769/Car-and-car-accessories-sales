...
class __TwigTemplate_9c9fa8175ae8e6fb5b0b2ea68a6fbe500f41f3b5bee3e874140df0571f953494 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/shoppe_zymphonies_theme/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupal\\themes\\shoppe_zymphonies_theme\\templates\\content-edit\\filter-tips.html.twig");
    }
